        ...
        children: <Widget>[
          HomeButton(
            ...
            () async {
              ...
              var dbPath = join(directory.path, "info.docx");
              ByteData data = await rootBundle.load("assets/informatie.docx");
              List<int> bytes = data.buffer
                  .asUint8List(data.offsetInBytes, data.lengthInBytes);
              await File(dbPath).writeAsBytes(bytes);
              PdftronFlutter.openDocument(dbPath);
            },
          ),
          HomeButton(
            Colors.green,
      ...
      appBar: PreferredSize(
          ...
          child: AppBar(
              ...
              flexibleSpace: Padding(
                  ...
                  child: Image.asset('assets/enver.png')))),
